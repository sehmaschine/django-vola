...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Plugin', fields ['group', 'container', 'slug']
        db.delete_unique('vola_plugin', ['group_id', 'container_id', 'slug'])


    def backwards(self, orm):
        # Adding unique constraint on 'Plugin', fields ['group', 'container', 'slug']
        db.create_unique('vola_plugin', ['group_id', 'container_id', 'slug'])
